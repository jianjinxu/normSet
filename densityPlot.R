...
densityPlot <- function(counts, group, col=c("lightblue","orange","MediumVioletRed","SpringGreen"), fn="densplot",outfile=TRUE){
  if (!I("figures" %in% dir())) dir.create("figures", showWarnings=FALSE)
  if (outfile) png(filename="figures/densityPlot.png",width=1800,height=1800,res=300)
